...
#define BSP_FEATURE_BSP_CODE_CACHE_VERSION                   (2)
...
#define BSP_FEATURE_BSP_HAS_ADC_CLOCK                        (1)
...
#define BSP_FEATURE_BSP_HAS_DTCM                             (0U) // TODO: Add support
#define BSP_FEATURE_BSP_HAS_EXTRA_PERIPHERAL0_CLOCK          (0U)
...
#define BSP_FEATURE_BSP_HAS_ITCM                             (0U) // TODO: Add support
...
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_NO_RAM_WAITS          (100000000U)
...
#define BSP_FEATURE_BSP_UNIQUE_ID_POINTER                    (0x02F07B00U)
...
#define BSP_FEATURE_CGC_HAS_EXTRACLK2                        (1)
...
#define BSP_FEATURE_CGC_PLL2_OUT_MAX_HZ                      (1200000000U)
#define BSP_FEATURE_CGC_PLL2_OUT_MIN_HZ                      (60000000U)
#define BSP_FEATURE_CGC_PLLCCR_TYPE                          (6U)
#define BSP_FEATURE_CGC_PLLCCR_VCO_MAX_HZ                    (2400000000U)
#define BSP_FEATURE_CGC_PLLCCR_VCO_MIN_HZ                    (960000000U)
#define BSP_FEATURE_CGC_PLLCCR_WAIT_US                       (0U) // No wait between setting PLLCCR and clearing PLLSTP
#define BSP_FEATURE_CGC_PLL_HOCO_MAX_CPUCLK_HZ               (960000000U)
#define BSP_FEATURE_CGC_PLL_OUT_MAX_HZ                       (1200000000U)
#define BSP_FEATURE_CGC_PLL_OUT_MIN_HZ                       (60000000U)
#define BSP_FEATURE_CGC_PLL_REFERENCE_CLK_MAX_HZ             (24000000U)
#define BSP_FEATURE_CGC_PLL_REFERENCE_CLK_MIN_HZ             (8000000U)
...
#define BSP_FEATURE_CGC_SCKDIVCR2_HAS_EXTRA_CLOCKS           (1)
...
#define BSP_FEATURE_DAC12_CHANNELS_PER_UNIT                  (0)
#define BSP_FEATURE_DAC12_UNIT_COUNT                         (0)

#define BSP_FEATURE_DAC8_CHANNELS_PER_UNIT                   (0)
...
#define BSP_FEATURE_DAC8_UNIT_COUNT                          (0)

#define BSP_FEATURE_DAC_AD_SYNC_UNIT_MASK                    (0x0U)
#define BSP_FEATURE_DAC_B_CHANNELS_PER_UNIT                  (1)
#define BSP_FEATURE_DAC_B_UNIT_COUNT                         (2)
#define BSP_FEATURE_DAC_HAS_CHARGEPUMP                       (0U)
#define BSP_FEATURE_DAC_HAS_DAVREFCR                         (0U)
#define BSP_FEATURE_DAC_HAS_DA_AD_SYNCHRONIZE                (0U)
...
#define BSP_FEATURE_DMAC_HAS_DMCTL                           (1U)
#define BSP_FEATURE_DMAC_HAS_REPEAT_BLOCK_MODE               (1U)
#define BSP_FEATURE_DMAC_MAX_CHANNEL                         (8U)

#define BSP_FEATURE_DOC_VERSION                              (2U)

#define BSP_FEATURE_DTC_TRANSFER_INFO_ALIGNMENT              (16)

#define BSP_FEATURE_DWT_CYCCNT                               (1U) // RA8P1 has Data Watchpoint Cycle Count Register

#define BSP_FEATURE_ELC_VERSION                              (2U)

#define BSP_FEATURE_ESC_MAX_PORTS                            (0)  // Feature not available on this MCU

#define BSP_FEATURE_ETHER_FIFO_DEPTH                         (0x0000070FU)
#define BSP_FEATURE_ETHER_MAX_CHANNELS                       (2U)
#define BSP_FEATURE_ETHER_MAX_QUEUE_NUM                      (64)
...
#define BSP_FEATURE_FLASH_USER_LOCKABLE_AREA_SIZE            (0) // Feature not available on this MCU
#define BSP_FEATURE_FLASH_USER_LOCKABLE_AREA_START           (0) // Feature not available on this MCU

#define BSP_FEATURE_GPT_32BIT_CHANNEL_MASK                   (0x3FFFU)
#define BSP_FEATURE_GPT_CLOCK_DIVIDER_STEP_SIZE              (2U)
#define BSP_FEATURE_GPT_CLOCK_DIVIDER_VALUE_7_9_VALID        (0U)
#define BSP_FEATURE_GPT_ODC_FRANGE_FREQ_MIN                  (160000000U)
#define BSP_FEATURE_GPT_ODC_FRANGE_SET_BIT(gpt_frequency) \
    ((BSP_FEATURE_GPT_ODC_FRANGE_FREQ_MIN <= gpt_frequency) ? 0x1 : 0) // Set to 1 if configured gpt frequency is _above_ FRANGE threshold
#define BSP_FEATURE_GPT_ODC_FREQ_MAX                         (300000000U)
...
#define BSP_FEATURE_ICU_IRQ_CHANNELS_MASK                    (0xFFFFFFFFU)
#define BSP_FEATURE_ICU_NMIER_MAX_INDEX                      (20U)                 // Max used index in NMIER
...
#define BSP_FEATURE_IIC_FAST_MODE_PLUS                       (0x07)
...
#define BSP_FEATURE_LPM_RTC_REGISTER_CLOCK_DISABLE           (0)                    // Feature not available on this MCU
...
#define BSP_FEATURE_LVD_MONITOR_1_HI_THRESHOLD               ((lvd_threshold_t) 3)  // 3.86V
...
#define BSP_FEATURE_LVD_MONITOR_2_HI_THRESHOLD               ((lvd_threshold_t) 3)  // 3.86V
...
#define BSP_FEATURE_LVD_MONITOR_MASK                         (0x1BU)                // LVD mask monitor 1,2,4,5
...
#define BSP_FEATURE_LVD_VERSION                              (3U)
...
#define BSP_FEATURE_SCI_LIN_CHANNELS                         (0x3FFU)
#define BSP_FEATURE_SCI_SPI_SCKSEL_VALUE                     (1U) // This enables a workaround for a HW bug. This should be fixed on the next cut of RA8P1
#define BSP_FEATURE_SCI_UART_ABCSE_RESTRICTED_CHANNELS       (0U)
#define BSP_FEATURE_SCI_UART_CSTPEN_CHANNELS                 (0x3FFU)
...
#define BSP_FEATURE_USB_HAS_USBHS_BC                         (1U)
