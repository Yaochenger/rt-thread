...
sci_b_uart_instance_ctrl_t     g_uart8_ctrl;
            ...
            {
                /* Baud rate calculated with 0.937% error. */ .baudrate_bits_b.abcse = 0, .baudrate_bits_b.abcs = 0, .baudrate_bits_b.bgdm = 1, .baudrate_bits_b.cks = 0, .baudrate_bits_b.brr = 42, .baudrate_bits_b.mddr = (uint8_t) 256, .baudrate_bits_b.brme = false
            };
